...
public class Exercise07 {
    ...
    public static void main(String[] args) {
        ...
        if (hoursOfHomework > 15 || (dayOfWeek.equals("Monday"))) {
            System.out.println("Time to do the homework...");
        } else if (hoursOfHomework > 15 || (dayOfWeek.equals("Tuesday"))){
            System.out.println("Time to do the homework...");
        } else if (hoursOfHomework > 15 || (dayOfWeek.equals("Wednesday"))) {
            System.out.println("Time to do the homework...");
        } else if (hoursOfHomework > 15 || (dayOfWeek.equals("Thursday"))) {
            System.out.println("Time to do the homework...");
        } else if (hoursOfHomework > 15 || (dayOfWeek.equals("Friday"))) {
            System.out.println("Time to do the homework...");
        } else if (hoursOfHomework < 15 && (dayOfWeek.equals("Saturday"))){
            System.out.println("I'm taking the day off!");
        } else if (hoursOfHomework < 15 && (dayOfWeek.equals("Sunday"))){
            System.out.println("I'm taking the day off!");
        }
